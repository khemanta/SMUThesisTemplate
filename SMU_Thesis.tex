...
%% You may reach out to Kumar Hemant, at <kumar.hemant.iitg@gmail.com>
%%
%% CREDITS:
%% This template is hacked version of original "Article" package available under the TeX and LaTeX
%% programming enviornment for document typesettings developed by Prof. Emeritus, Donald E. Knuth of 
%% Stanford University and author of "The Art of Programming".
%% The LaTeX typesettings are borrowed largely from book, "The \LaTeX Companion" by Leslie Lamport. 
%%
